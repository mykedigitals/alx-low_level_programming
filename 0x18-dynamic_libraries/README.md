...
Don’t forget to push your `dynamic.h` file in your repository, containing at least all the prototypes of the above functions.

```
julien@ubuntu:~/0x17. Dynamic libraries$ ls -la lib*
-rwxrwxr-x 1 julien julien 13632 Jan  7 06:25 libdynamic.so
julien@ubuntu:~/0x17. Dynamic libraries$ nm -D libdynamic.so 
...
julien@ubuntu:~/0x17. Dynamic libraries$ gcc -Wall -pedantic -Werror -Wextra -L. 0-main.c -ldynamic -o len
